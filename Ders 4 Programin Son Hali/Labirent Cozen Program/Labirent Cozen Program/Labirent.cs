...
namespace Labirent_Cozen_Program
{
    ...
    {
        private string VarsayilanLabirent= "";
        ...
        public bool KapilarVarMi()
        {
            if (baslangicKapiVeri[0] == 0 && baslangicKapiVeri[1] == 0 || bitisKapiVeri[0] == 0 && bitisKapiVeri[1] == 0)
            {
                return false;
        ...
        public int[] BaslangicKapi_Veri_Al()
        {
            return baslangicKapiVeri;
        }
        public int Labirent_Coz(int x, int y)
        {
            if (veriler[x, y] == 3)
            {
                return 1;
                //1 degeri dondurmek sonuca ulasildigi anlamina geliyor
            }
            if (veriler[x,y]==0 || veriler[x, y] == 2)
            {
                if (veriler[x, y] != 2)
                {
                    hucreler[x, y].BackColor = Color.Yellow;
                    hucreler[x, y].ForeColor = Color.Yellow;
                }
                veriler[x, y] = 1;
                //artik bu hucreden gecildigi anlamina geliyor
        ...
        public void Labirent_Getir(string labirent)
        {
            if (labirent == "")
            {
                labirent = VarsayilanLabirent;
            }
            int sayac = 0;
            int veri;
            for (int y = 1; y < 29; y++)
            {
                for (int x = 1; x < 29; x++)
                {
                    ...
                    {
                        veri = (int)Char.GetNumericValue(labirent[sayac]);
                    }
                    Veri_Degistir(x,y,veri);
                    sayac++;
                }
            }
        }
        public int Labirent_VeriAl(int x, int y)
        {
            return veriler[x, y];
        }
    }
